...
public class NotificationService extends AccessibilityService {
    ...
    private static final String TAG = "CodePayMonitor";
    ...
    public void onServiceConnected() {
        ...
        Toast.makeText(this, "码支付监控已启动", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
        ...
        if (notify != null) {
            ...
            // 发送广播通知主界面
            Intent intent = new Intent("com.codepay.PAY_RECEIVED");
    ...
    private void notifyServer(PayNotify notify) {
        ...
        // 构建请求参数
        // 注意：这里需要根据实际业务逻辑获取订单号
        // 可以通过金额匹配，或者通过本地数据库查询
